...
function vmoveplayer(dx, dy)
	...
	-- try to climb
	if (dy != 0) then
		if (canwalkto(x, y, flags) and vcanpushblockto(x, y, flags)) then
			player.x += dx
			player.y += dy
			return true
		end
	...
	if (dx != 0) then
		...
		-- standable map tiles
		if (standable(bx, by) or standable(x, y)) then
			player.x += dx
			return true
		else
			-- fall off ledge
...
__gff__

...
__map__

