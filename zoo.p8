...
function _init()
	...
	elseif (state.lvl == 2) then
		...
		exit.y = 5
		exit.sprite = index.cexit
		aa(blocks, index.block, {10,3,10,6, 3,6,2,5,3,4,4,4,4,5})
		aa(animals, index.rabbit, {9,7,11,8,9,1,11,2})
		sprites[3][5] = index.key4
...
function updatewornitems()
	...
	if (player.goalcount == player.goalneededcount) then
		exit.sprite = index.oexit
		state.phase = keyitemphase
		dialogindex = 1
...
__map__

...

