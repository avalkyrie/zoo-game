...
function _init()
	...
	elseif (state.lvl == 1) then
		...
		dialog[introphase] = {
			...
			"animation: 1.2",
			"noah: i thought this day would never end! i can finally go home and celebrate my big day... at home and alone.",
			"noah: just how i like it.",			
			"karen: noah can you please lock the office when you're done? had to leave early. sorry! exhibits should be locked already!",
			"animation: 1.3",
			"noah: of course, boss! no problem.",
			"noah: well i guess my couch will have to wait.",
			"animation: 1.4",
			"noah: hold on, where are my keys? they were on my belt a second ago..",
			"animation: 1.5",
	...
	elseif (state.lvl == 2) then
		...
		dialog[introphase] = {
			...
			"noah: wait!",
			"animation: 2.2",
			"noah: at least he dropped the tundra key before he left.",
			"noah: why are all these crates in the middle of the bunny enclosure? am i the only one who does any work around here?",
	...
	elseif (state.lvl == 6) then
		...
		dialog[introphase] = {
			"animation: 6.1",
			"noah: i am not loving how high i am in these trees. there you are mackers!",
			"animation: 6.2",
		...
		dialog[outrophase] = {
			"noah: the key to the aquarium!",
			"noah: he can't get that far! monkeys can't swim... right?"
		}
		player.goal = "goal: collect yellow key"
	...
	elseif (state.lvl == 4) then
		...
		dialog[advancephase] = {
			...
			"noah: yes, karen. i haven't left yet.",
			"karen: oh, great! please make sure the penguins are ready for the evening before you go. they are in the tundra.",
	...
	elseif (state.lvl == 5) then
		...
		dialog[introphase] = {
			...
			"noah: there is a straggler penguin on the *other* side of this freezing water.",
			"noah: how am i supposed to get across? i wonder if these crates float...",
		}
		dialog[outrophase] = {
			"noah: glad those crates could bridge the gap! ",
			"noah: brrr...i didn't realize how cold it was. i'll warm up in the jungle.",
			"noah: monkeys like jungles right? he's probably there"
		}
	...
	iteratemap(
		function(i,j)
			if (blocks[i][j] and band(fget(mgetspr(i,j)), fwater) > 0) then
				...
				if (state.lvl == 10) then
					msetspr(index.dwblock,i,j)
				else
...

...

...

...
__gff__

...

