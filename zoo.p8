...
function _init()
	...
	if (state.lvl == 0) then
		...
		aa(animals, index.rabbit, {2,9,2,10,3,11})
		aa(animals, index.bbird1, {2,5})
		aa(animals, index.pbird2, {15,2,16,5})
		animals[5][15] = index.monkey
...
function draw_startmenu()
	...
	rectfill(23-1,30-1,66,35, 11)
	print ("i t ' s   a",  23, 30, 1)
	if (tick % 120 >= 60) then
...

...

...

__sfx__
